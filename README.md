...
# 创建 OpenHarmony 目录
mkdir -p /mnt/sda/OpenHarmony-7.0-Release/OpenHarmony
cd /mnt/sda/OpenHarmony-7.0-Release/OpenHarmony
...
```bash
# 初始化 repo
~/ohos/repo init -u https://gitcode.com/openharmony/manifest -b OpenHarmony-7.0-Release -g ohos:mini --no-repo-verify
